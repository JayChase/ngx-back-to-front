...
const AppServerModuleNgFactory = require('../dist-server/main.6d1967bbd22ce0e9b3d7.bundle.js').AppServerModuleNgFactory; // bundle name set by npm script build-set-server-main-bundle
