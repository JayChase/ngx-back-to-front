...
const AppServerModuleNgFactory = require('../dist-server/main.106c4b21ce01aefadee0.bundle.js').AppServerModuleNgFactory; // bundle name set by npm script build-set-server-main-bundle
